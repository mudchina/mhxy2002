...
void create()
		...
		"一口陈旧平凡，决不会引起任何人注意的箱子。扁扁的一口箱子，有一尺多宽，两尺多长，整个箱子用暗褐色的牛皮包着。你可用它（make）或（remake）出当今武林中的任何神兵利器,如果你没有能力的话，将什么也得不到。\n");
...
if(arg=="baihuasword")
        {obj=new(__DIR__"baihua");
         obj->move(me);
        
write("你将手中的箱子打开，用其中的零件拼成了一把无双百花剑。\n");}
