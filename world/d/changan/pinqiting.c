...
品棋亭南眺泾水，北靠长安高墙，虽不是四野开阔，却也是
手谈休栖的好地方。亭中有一张石桌，上面划着一张围棋盘。
桌角摆放着棋子。另外还有两张石凳，颜色一深一浅。
LONG);
  ...
  "/d/obj/misc/seat" : 2,
  "/d/xueshan/npc/shenying-shizhe" : 1,
]));
  set("exits", ([ /* sizeof() == 1 */
  "out" : __DIR__"xiaoqiu",
]));
...
void init()
{
        object zhinan = present("xiaqi zhinan",this_object());
