...
int follow_player (object me, object who)
{
  ...
  if (! who)
    return 1;
  if (who->query("obstacle/chechi")=="done"||who->query("obstacle/huoyun")!="done")
    return 1;
...
message("channel:chat",HIC"¡¾È¡¾­¡¿¹ÛÒôÆÐÈø(guanyin pusa)£º"+who->query("name")+"´³¹ýÎ÷ÐÐÈ¡¾­µÚ"HIW"Ê®Îå"HIC"¹Ø£¡\n"NOR,users());//this is by tianlin 2002.1.23
