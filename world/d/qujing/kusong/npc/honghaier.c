...
int recruit_apprentice(object ob)
{
        if( ::recruit_apprentice(ob) ) {
                ob->set("class", "yaomo");
                ob->set("title", RED"枯松涧"HIC"火"HIW"云"HIR"洞"BLK"妖王"NOR);
...
int rank_me()
{
        ...
        && (string)me->query("family/master_id") == "honghai er"){
                ...
                if( exp <= 10000 ){
                        me->set("title", YEL"枯松涧"HIM"火云洞"HIR"巡山小妖"NOR);
                } else if(exp <= 50000 ){
                        me->set("title", YEL"枯松涧"HIM"火云洞"HIR"先锋"NOR);
                } else if(exp < 100000 ){
                        me->set("title", YEL"枯松涧"HIM"火云洞"HIR"健将"NOR);
                } else if(exp <= 250000 ){
                        me->set("title", YEL"枯松涧"HIM"火云洞"HIR"巡山大将"NOR);
                } else if(exp <= 500000 ){
                        me->set("title", YEL"枯松涧"HIM"火云洞"HIR"妖王"NOR);
                } else if(exp <= 1000000 ){
                        me->set("title", YEL"枯松涧"HIM"火云洞"HIR"魔王"NOR);
                } else if(exp <= 1500000 ){
                        me->set("title", YEL"枯松涧"HIM"火云洞"HIR"长老"NOR);
                } else {
                        me->set("title", YEL"枯松涧"HIM"火云洞"HIR"洞主"NOR);
                }
...
//By tianlin@mhxy for 2002.1.19.修改成掉100 kee and 100 sen,我想了想改成不掉的也不大好.
        ob->receive_damage("kee", 100);
        ob->receive_damage("sen", 100);
        // ob->unconcious();//By tianlin@mhxy for 2001.12.14修改wzg kill player bug
        }
