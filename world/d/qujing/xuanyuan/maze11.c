...
{       
        ...
        if( me->query_temp("xmaze11") == 0 )
        {
                me->set_temp("xmaze11", 1);
        }
        else if( me->query_temp("xmaze11") == 1 )
        {
                reset_path(me);
        }
        
        if( check_out(me) ) me->move(__DIR__"yongdao2");
}
