...
string zname(object);
#include <ansi.h>
#define DIRNAME "/d/qujing/bibotan/npc/"

#define MYFILE "/d/qujing/bibotan/npc/zhangmen.c"
...
void init()
{
	...
	me->create_identity("/d/qujing/bibotan/npc/longwang", "/d/qujing/bibotan/shuijg");
