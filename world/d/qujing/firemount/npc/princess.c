...
//By tianlin@mhxy for 2002.3.11ÓÅ»¯
#include <ansi.h>
#define NAME "ÌúÉÈ¹«Ö÷"
inherit NPC;
inherit F_MASTER;
...
void create()
{
  ...
  set("title", HIR"»ğÑæÉ½ºìÂÚÂŞÉ²"NOR);
  set("gender", "Å®ĞÔ");
  set("age", 28);
  set("per", 18);
...
{//disabled announce and reward...
  ...
  if (who->query("obstacle/firemount") == "done" || who->query("obstacle/dudi") != "done")
  {
...
message("channel:chat",HIC"¡¾È¡¾­¡¿¹ÛÒôÆĞÈø(guanyin pusa)£º"+who->query("name")+"´³¹ıÎ÷ĞĞÈ¡¾­µÚ"HIW"¶şÊ®"HIC"¹Ø£¡\n"NOR,users());//this is by tianlin 2002.1.23
