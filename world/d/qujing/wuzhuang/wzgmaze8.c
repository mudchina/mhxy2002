...
LONG);
	...
	set("exits", 
	([ //sizeof() == 4
		"southeast" : __DIR__"wzgmaze1",
		"northeast" : __DIR__"wzgmaze4",
		"northwest" : __DIR__"wzgmaze7",
	]));
...
{       
	...
	if( me->query_temp("wzgmaze8") == 0 )
	{
		me->set_temp("wzgmaze8", 1);
	}
	else if( me->query_temp("wzgmaze8") == 1 )
	{
		reset_path(me);
	}
