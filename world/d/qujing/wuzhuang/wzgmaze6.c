...
LONG);
	...
	set("exits", 
	([ //sizeof() == 4
		"southeast" : __DIR__"wzgmaze2",
		"northeast" : __DIR__"wzgmaze5",
		"southwest" : __DIR__"wzgmaze7",
	]));
...
{       
	...
	if( me->query_temp("wzgmaze6") == 0 )
	{
		me->set_temp("wzgmaze6", 1);
	}
	else if( me->query_temp("wzgmaze6") == 1 )
	{
		reset_path(me);
	}
