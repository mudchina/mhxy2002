...
LONG);
	...
	set("exits", 
	([ //sizeof() == 4
		"west" : __DIR__"wzgmaze7",
		"southwest" : __DIR__"wzgmaze2",
		"northwest" : __DIR__"wzgmaze4",
	]));
...
{       
	...
	if( me->query_temp("wzgmaze3") == 0 )
	{
		me->set_temp("wzgmaze3", 1);
	}
	else if( me->query_temp("wzgmaze3") == 1 )
	{
		reset_path(me);
	}
