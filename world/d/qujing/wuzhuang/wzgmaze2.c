...
LONG);
	...
	set("exits", 
	([ //sizeof() == 4
		"southwest" : __DIR__"wzgmaze1",
		"northeast" : __DIR__"wzgmaze3",
		"northwest" : __DIR__"wzgmaze6",
	]));
...
{       
	...
	if( me->query_temp("wzgmaze2") == 0 )
	{
		me->set_temp("wzgmaze2", 1);
	}
	else if( me->query_temp("wzgmaze2") == 1 )
	{
		reset_path(me);
	}
