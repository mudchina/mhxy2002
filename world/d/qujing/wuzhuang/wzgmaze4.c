...
LONG);
	...
	set("exits", 
	([ //sizeof() == 4
		"northwest" : __DIR__"wzgmaze5",
		"southeast" : __DIR__"wzgmaze3",
		"southwest" : __DIR__"wzgmaze8",
	]));
...
{       
	...
	if( me->query_temp("wzgmaze4") == 0 )
	{
		me->set_temp("wzgmaze4", 1);
	}
	else if( me->query_temp("wzgmaze4") == 1 )
	{
		reset_path(me);
	}
