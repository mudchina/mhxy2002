...
void announce_success (object who)
{
  ...
  if (who->query("combat_exp") < 10000)
    return;
  if (who->query("obstacle/sanda") == "done") || who->query("obstacle/heishui") != "done")
    return;
  ...
  message("channel:chat",HIY"¡¾¹ý¹ØÕ¶½«¡¿¹ÛÒôÆÐÈø(guanyin pusa)£º"+who->query("name")+"´³¹ýÎ÷ÐÐÈ¡¾­[1;37mµÚËÄÊ®¹Ø£¡\n"NOR,users());
