...
void create()
{
        ...
        set_skill("force", 50);
        set_skill("umbrella", 50);
        set_skill("dodge", 50);
        set_skill("parry", 50);
        set_skill("lingfan-san", 50);
        ...
        set("mana_factor", 10);
        setup();
        carry_object("/d/lingjie/obj/miaodi")->wield();
...
void leave()
{
        message("vision",HIW"护法双手抱拳，微一躬身，转身驾云而去。\n"NOR, environment(),  this_object());
...
{       int i;
	...
	object me=this_object();
        copy_status(me,who);
        message("vision",HIW"天空中一朵七彩云飘过，云过处，现出一护法金身\n\n"NOR, environment(),  this_object());
