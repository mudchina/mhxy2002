...
#define DIRNAME "/d/wusheng/npc/"

#define MYFILE "/d/wusheng/npc/zhangmen.c"
...
void init()
{
	...
	object who = this_player();
         ...
         me->create_identity("/d/wusheng/npc/kongwu", "/d/wusheng/room6");
...
string zm_apply()
{
	...
	{
		return "你非但无情无义，而且叛师欺祖，言无信行不轨，岂能出任掌门弟子一职！\n";
	}
	...
	ob->set_temp("wusheng_zm_applied", 1);
...
int accept_fight(object ob)
{
	...
	if (ob->query_temp("wusheng_zm_applied"))
	{
...
int check_result(object me, object ob)
{
	...
	if (((int)me->query("kee")*100/(1+my_max_kee)) <= 50 )
	{
		...
		if( ob->query_temp("wusheng_zm_applied") != 1 )
			return 1;	
		...
		{
			message_vision ("$N躬身对$n说道：恭请见过师父。\n",me,ob);
...
void master_announce (object me, object who, object ob)
{
	...
	ob->delete_temp("wusheng_zm_applied");
	me->set("new_player",1);
