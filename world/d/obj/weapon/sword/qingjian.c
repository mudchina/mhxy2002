...
void create()
{
       set_name(HIC"青索剑"NOR, ({ "qingsuo-sword","sword","jian"}));
        set_weight(1);
        if( clonep() )
...
message_vision("$N轻轻将双剑和体,向上天祈祷 !\n\n突然,一声龙吟过后,"+MAG"紫气"NOR+"自东而来,钻入你右手 \n你心念方才一动,一声凤鸣过后,"+HIC"青气"NOR+"从天而降,钻入你左手\n\n剑身有一层"+HIC"青"NOR+"气与"+MAG"紫"NOR+"气隐隐笼罩.且渐渐融和 !!\n一声轻啸,你手中多出一把"+HBRED+HIC"紫青双剑\n\n"NOR,who);
        message("channel:rumor",HIM+"【谣言】某人：听说"HIY+who->query("name")+HIM"在"HIW+MISC_D->find_place(environment(this_player()))+HIM"附近得到了传说中的"NOR+HIW" ["NOR+HBRED+HIC"紫青双剑"NOR+HIW"]"NOR+HIM" 不知道是真是假！\n"+NOR,users() );
