...
void create()
{
        set_name(HIB "蓝龙珠" NOR, ({ "lan longzhu","zhu" }));
        set_weight(1);
        if( clonep() )
...
destruct(this_player()->carry_object("/d/luzhong/obj/1"));
destruct(this_player()->carry_object("/d/luzhong/obj/2"));
destruct(this_player()->carry_object("/d/luzhong/obj/3"));
destruct(this_player()->carry_object("/d/luzhong/obj/4"));
destruct(this_player()->carry_object("/d/luzhong/obj/5"));
destruct(this_player()->carry_object("/d/luzhong/obj/6"));
destruct(this_player()->carry_object("/d/luzhong/obj/7"));
        real->move(me);
