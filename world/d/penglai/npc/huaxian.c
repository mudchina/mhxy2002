//modified by tianlin for xyj
//modified by yinbin for xyj
//2001-5-1 
...
int do_stop() {
  ...
  if (score>15000)
      score=15000; //added by vikee,dx must under 15 year.
...
int do_throw(string arg)
{
  ...
  message_vision("$N掏出暗器，看了看仙子，信心不足，又把暗器收了起来。\n",who,me);
...
int do_cut(string arg)
{
  ...
  message_vision("$N掏出剃刀，看了看仙子，信心不足，又把暗器收了起来。\n",who,me);
