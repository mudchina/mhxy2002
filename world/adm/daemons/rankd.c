...
string *dx_level_desc = ({
   ...
   /*   HIC "仙福"HIW"永享" NOR,  //3375x2=6750
	HIR "寿"HIY"与"HIC"天"HIW"齐" NOR,  //3375x2=6750
	BLINK+HIR "佛"HIY"仙"HIC"齐"HIW"拜" NOR,  //3375x2=6750
	BLINK+HIR "古"HIY"今"HIC"同"HIW"生" NOR  //3375x2=6750
*/
});
...
/*	HIR "无"HIY"法"HIC"无"HIW"天" NOR,  //169x40=6760
	BLINK+HIR "逆"HIY"转"HIC"时"HIW"光" NOR  //169x40=6760 */
});
...
/*
	...
	HIR "天下"HIY"无双" NOR,
	HIC "笑傲"HIW"西游" NOR,
	HIR "群"HIY"雄"HIC"之"HIW"尊" NOR,
	HIR "佛"HIY"哭"HIC"帝"HIW"怒" NOR,
	HIR "绝"HIY"天"HIC"灭"HIW"地" NOR,
	HIR "擎"HIY"日"HIC"挽"HIW"月" NOR,
HIR "田"HIY"林"HIC"无"HIW"敌" NOR
*/
});
...
string _query_rank(object ob)
{
	...
	case "女性":
		switch(wizhood(ob)) {
                        case "(admin)": return  HIW "【 巫 神 】" NOR;
			case "(arch)":		return  HIW "【 大巫女 】" NOR;
			case "(wizard)":	return  HIW "【正式巫女】" NOR;
			case "(apprentice)":	return  HIW "【见习巫女】" NOR;
                        	case "(immortal)":      return  HIW "【客座巫女】" NOR;
...
case "lingjie":
        if(dx<10000)
                ...
                return HIM "【 "+at+"灵女 】" NOR;
        else
                return HIM "【 "+at+"灵母 】" NOR;
          break;
case "tiankongjie":       
        if(dx<1000) 
                return GRN "【 灵师 】" NOR;
...
case "wudang":		           
	if(dx<1000) 
		...
		return YEL "【"+at+"玄女】" NOR;	
	else 
		return YEL "【"+at+"师太】" NOR;
	break;
case "huli":
        if((int)ob->query("combat_exp")<10000)
                return HIY "【  小 狐 狸  】" NOR;
        else if((int)ob->query("combat_exp")<100000)
                return MAG "【  狐 狸 精  】" NOR;
        else if((int)ob->query("combat_exp")<1000000)
                return CYN "【  千年狐狸  】" NOR;
        else
                return YEL "【  "+ob->query("added_title")+"狐仙  】" NOR;
        break;
case "tianpeng":		           
	if(dx<1000) 
		return CYN "【 小妖女 】" NOR;
		...
		return CYN "【"+at+"魔女】" NOR;	
	else 
		return CYN "【"+at+"公主】" NOR;
	break;
...
case "shenjian":		           
        if(exp<1000) 
                ...
                return HIG "【"+at+"侠女】" NOR;
        else 
                return HIG "【"+at+"大侠】" NOR;
	break;
case "hero":
        if(exp<1000) 
                return HIG "【 女  侠 】" NOR;
...
if ( ob->query("family/family_name") == "乱石山碧波潭" )
	if(avg<1000) 
		return RED "【 小妖女 】" NOR;
	else if(avg<10000) 
		return RED "【 妖  精 】" NOR;	
...
case "fighter":		
	if(exp<1000) 
		...
		return HIR "【"+at+"女将军】" NOR;	
	else 
		return HIR "【"+at+"女元帅】" NOR;
	break;
case "youling":	
	if(avg<1000) 
		return HIB "【阴曹小鬼】" NOR;
...
//begin 男性：
	default:
		switch(wizhood(ob)) 
		{
			case "(admin)":		return  HIW "【 天  神 】" NOR;//this is by tianlin 2001.5.1
			case "(arch)":			return  HIW "【 大巫师 】" NOR;
			case "(wizard)":		return  HIW "【正式巫师】" NOR;
			case "(apprentice)": 	            return  HIW "【见习巫师】" NOR;
                        	case "(immortal)":               return  HIW "【客座巫师】" NOR;
			case "(elder)": 	            return  HIW "【荣誉玩家】" NOR;
			default:
				switch(ob->query("class")) 
				{
...
case "lingjie":
        if(dx<10000)
                ...
                return HIC "【 "+at+"灵者 】" NOR;
        else
                return HIC "【 "+at+"灵主 】" NOR;
          break;
case "tiankongjie":  
        if(dx<1000) 
                return GRN "【 四方使 】" NOR;
                ...
                return GRN "【"+at+"罗帝】" NOR;
        else 
                return GRN "【"+at+"天】" NOR;
        break;
case "wusheng":// by tianlin 2001.7.1		           
	if(dx<1000) 
		return GRN "【 大罗刹 】" NOR;
	else if(dx<10000) 
		return GRN "【 大罗汉 】" NOR;	
...
case "wudang":// by tianlin 2001.9.29		           
	if(dx<1000) 
		return YEL "【 小道士 】" NOR;
	else if(dx<10000) 
		return YEL "【 道  士 】" NOR;	
		...
		return YEL "【"+at+"天师】" NOR;	
	else if(dx<1000000) 
		return YEL "【"+at+"真人】" NOR;
	else 
		return YEL "【"+at+"祖师】" NOR;
	break;
case "shaolin":// by tianlin 2001.9.29		           
	if(dx<1000) 
		return HIY "【 小沙弥 】" NOR;
	else if(dx<10000) 
		return HIY "【 小  僧 】" NOR;	
...
case "tianpeng":		           
	if(dx<1000) 
		...
		return CYN "【"+at+"老魔】" NOR;	
	else 
		return CYN "【"+at+"魔王】" NOR;
	break;
//by tianlin 2001.12.14
case "shenjian":		           
        if(exp<1000) 
                return HIG "【 剑  客 】" NOR;
        else if(exp<10000) 
...
if ( ob->query("family/family_name") == "火云洞" )
	if(avg<1000) 
		...
		return RED "【"+at+"魔王】" NOR;
if ( ob->query("family/family_name") == "乱石山碧波潭" )//加入bibotan
	if(avg<1000) 
		return RED "【 小  妖 】" NOR;
	else if(avg<10000) 
		return RED "【 妖  怪 】" NOR;	
	...
	if(avg<1000) 
		...
		return MAG "【"+at+"老魔】" NOR;
	else 
		return MAG "【"+at+"魔王】" NOR;
 if ( ob->query("family/family_name") == "大雪山" )
