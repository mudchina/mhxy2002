...
int damage, def;
 ...
 return notify_fail("你手上无铲不能使用绝杀！\n");
...
message_vision(msg, me ,target);
{
 msg =  HIC "$N仰天长啸，一式"HIW"『绝杀三连』"HIC"奇快无比的向$n连续刺出三叉！\n"NOR;
        message_vision(msg, me, target);
me->set("juesha", 5);
