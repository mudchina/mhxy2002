        ...
        message_vision("$N一仰脖，吞下了一颗" + this_object()->name() +
                ...
                tell_object(me, HIG "你的skills已经提升了，"
                            "请先jifa上你的skills，然后再问巫师要dan。祝你西行快乐！\n" NOR);
                                     me->set_skill("shushan-force",120);
                            me->set_skill("xianfeng-spells",120);
                            me->set_skill("songhe-sword",120);
                            me->set_skill("zuixian-steps",120);
                            ...
                            me->set_skill("unarmed",120);
                                                 ...
                                                 me->set_skill("snowwhip",120);
                                                 me->set_skill("whip",120);
                                                 me->set_skill("yujianshu",120);
                                                me->set_skill("fumozhang",120);                          
