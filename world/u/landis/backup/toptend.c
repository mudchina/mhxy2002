//Cracked by Roath
//By tianlin@mhxy 2001.8.17.加入mana的排行
#include <ansi.h>
#include <mudlib.h>
...
#define TOPTEN_MANA	"/topten/mana.txt"
#define TOPTEN_PER	"/topten/per.txt"
#define TOPTEN_AGE	"/topten/age.txt"
#define TOPTEN_TASK	"/topten/task.txt"
#define RICH_B 		CYN"梦幻西游十大"HIC"富豪(RICH）"NOR
#define QUESTS_B        CYN"梦幻西游十大"HIC"解迷高手（QUESTS）"NOR
#define PKER_B 		CYN"梦幻西游十大"HIC"P K 狂魔（PKER）"NOR
#define NKER_B 		CYN"梦幻西游十大"HIC"N K 高手（NKER）"NOR
#define EXP_B  		CYN"梦幻西游十大"HIC"武学高手（EXP）"NOR
#define DX_B 	        CYN"梦幻西游十大"HIC"道行高手（DX）"NOR
#define FORCE_B		CYN"梦幻西游十大"HIC"内力高手（FORCE）"NOR
#define PER_B		CYN"梦幻西游十大"HIC"美女（PER）"NOR
#define AGE_B		CYN"梦幻西游十大"HIC"老前辈（AGE）"NOR
#define TASK_B		CYN"梦幻西游十大"HIC"TASK高手（TASK）"NOR
#define MANA_B		CYN"梦幻西游十大"HIC"法力高手（MANA）"NOR
