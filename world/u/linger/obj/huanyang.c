// huanyang.c 还阳丹
//By tianlin@mhxy for 2002.1.24,改良
#include <ansi.h>
...
//休想用WIZ权利给player任何帮助 
       message("channel:chat",HIC"【"HIY"梦幻西游"HIC"】"HIR"公正法官(faguan)：发现"+this_player()->query("name")+"吃了一颗"HIG"还阳丹"HIR"，功力增强了好几倍！\n"NOR,users());//this is by tianlin 2002.1.24
