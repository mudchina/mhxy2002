...
//	create_family("少林派", 0, "弟子");
	...
	setup();
	carry_object("/d/suburb/xkx/city/obj/gangdao")->wield();
...
int random_move()
{
	...
	if ( (string)file_name(where) == "/d/suburb/xkx/village/hsroad2" )
	{
//		command("我得朝南走。");
		command("go south");
		return 1;
	...
	if ( (string)file_name(where) == "/d/suburb/xkx/wudang/wdroad5" )
	{
//		command("我得朝北走。");
		command("go north");
		return 1;
