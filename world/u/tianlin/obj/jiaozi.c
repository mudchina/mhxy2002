...
void create()
{
  ...
  if( clonep() )
    ...
    set("long", 
    "一盘热腾腾的饺子(jiao zi),这是田林亲手给您包的,祝您新春快乐!\n快吃(eat)了吧。:D\n");
    set("unit", "盘");
  }
  setup();
}
...
int do_eat(string arg)
{
  ...
  if (me->query("tianlin_jiaozi"))
    return notify_fail(HIY"你已经吃过饺子了,给别人留点吧？\n"NOR);
...
tell_object(me,HIR"                梦幻" HIC "西游" HIY "巫师组祝您新春愉快!\n" NOR);

  me->set("tianlin_jiaozi",1);   
