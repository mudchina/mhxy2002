...
set("objects", ([ /* sizeof() == 1 */
  __DIR__"npc/stockboss" : 1,
       ...
       setup();
== 未完继续 51% == (ENTER 继续下一页，q 离开，b 前一页)
}
void init()
{
...
>l
〖彩票购买窗口〗   - /d/city/stockroom
    
这是灵剑传奇的彩票购买站。如果你想发财的话，
你可以花10两黄金购买一张彩票。
    这里唯一的出口是 south。
  灵剑传奇 彩票商&&居民注册官(Stock seller)
>more stock
没有这个档案。
>more stock seller
//stockboss.c  彩票商
...
{
    reload("stockboss");
   set_name(HIC"彩票商&&居民注册官"NOR, ({"stock seller", "boss","officer"}));
== 未完继续 5% == (ENTER 继续下一页，q 离开，b 前一页)
   set("title",HIY"灵剑传奇"NOR);
   set("age",19);
   set("gender","女性");
   set("per",40);
   set("attitude", "peaceful");
   set("long",
"她是灵剑传奇的彩票出售员，你可以用choose <5位没有重复数字的号码>\n"
...
"上期没有买完5张数额的不需消号，在买下期的时候，系统自动消号。\n");
  ...
  "rsg":(: give_rsg :),
   ...
   "中奖号码":(: report_num :),
   "开奖":(: check_time :),
== 未完继续 10% == (ENTER 继续下一页，q 离开，b 前一页)
   "mynum":(: tell_num :),
   "消号":(: del_num :),
//   "注册":(: set_up :),
//   "title":(: set_title :),
...
message("system",HIR"【奖品预告】"+BLINK HIB"柳依依"NOR+HIR"： 第"+to_chinese(query("stocknum"))+"期彩票特奖奖品（第一个兑奖的）为："+BLINK HIY""+to_chinese(4*query("stock_nowin"))+"个人参果"NOR+HIC"或"+BLINK HIY""+to_chinese(2000*query("stock_nowin"))+"两黄金！\n"NOR,users());
  message("system",HIR"【彩票开奖】灵剑传奇彩票管委会： 现在准备公开抽选第"+to_chinese(query("stocknum"))+"期彩票特奖中奖号码！\n"NOR,users());
this_object()->set("nosell_time",time());
set("start_time",time());   
set_temp("starting",1);   
== 未完继续 15% == (ENTER 继续下一页，q 离开，b 前一页)
...
if(!query_temp("starts")){
   message("system",HIR"【彩票开奖】灵剑传奇彩票管委会： 现在开始抽选第一位号码！\n"NOR,users());
call_out("choose",30);}
else {
message("system",HIR"【彩票开奖】灵剑传奇彩票管委会： 第"+to_chinese(query_temp("starts"))+"位号码是"+BLINK HIY""+query_temp("nums")+"\n"NOR,users());
if(query_temp("starts")<5){
message("system",HIR"【彩票开奖】灵剑传奇彩票管委会： 现在开始抽选第"+to_chinese(query_temp("starts")+1)+"位号码！\n"NOR,users());
call_out("choose",30);}
...
== 未完继续 26% == (ENTER 继续下一页，q 离开，b 前一页)
...
void finish()
== 未完继续 31% == (ENTER 继续下一页，q 离开，b 前一页)
{
 object me=this_object(); 
...
me->delete_temp("starting");
   message("system",HIR"【彩票开奖】灵剑传奇彩票管委会： 5位号码已产生！\n"NOR,users());
   message("system",HIR"【彩票开奖】灵剑传奇彩票管委会： 第"+to_chinese(query("stocknum"))+"期最后的中奖号码就是：\n"NOR,users());
   message("system",HIR"【彩票开奖】灵剑传奇彩票管委会：\n\n\n"+BLINK HIW"                         "+to_chinese(num1)+to_chinese(num2)+to_chinese(num3)+to_chinese(num4)+to_chinese(num5)+"\n"NOR,users());
...
== 未完继续 37% == (ENTER 继续下一页，q 离开，b 前一页)
  object ob;
 ...
 if(win) {
  ...
  message("system",HIR"【大奖通知】灵剑传奇彩票管委会： 第"+to_chinese(query("stocknum"))+"期特奖得主"+who->query("name")+"("+who->query("id")+")前来领奖！获得黄金"+to_chinese(t*2000)+"两！\n"NOR,users());

 message_vision("$N对$n笑嘻嘻的拱手道：“恭喜发财！”\n",me,who);
message_vision("$N对$n说道：“"+to_chinese(t*2000)+"两黄金已经存入你的银行账户。”\n",me,who);
== 未完继续 42% == (ENTER 继续下一页，q 离开，b 前一页)who->add("balance",t*20000000);
...
== 未完继续 47% == (ENTER 继续下一页，q 离开，b 前一页)
    {
...
message_vision("$N对$n说道：“刚开过奖，暂时不出售彩票,现在专职兑奖和消号。现在\n离第"+to_chinese(query("stocknum")+1)+"期彩票开售还有"+to_chinese(hour)+"小时"+to_chinese(min)+"分钟"+to_chinese(sec)+"秒！欢迎您到时光临！”\n",this_object(),this_player());}
  ...
  if(query("number")) {
     me->delete("number");
  me->add("stocknum",1);
message("system",HIR"【彩票开售通知】灵剑传奇彩票管委会： 第"+to_chinese(query("stocknum"))+"期彩票现在开始出售，欢迎大家到kz u n购买！\n"NOR,users());
...
message("system",HIR"【奖品预告】"+BLINK HIB"柳依依"NOR+HIR"： 第"+to_chinese(query("stocknum"))+"期彩票特奖奖品（第一个兑奖的）为："+BLINK HIY""+to_chinese(4*query("stock_nowin"))+"个人参果"NOR+HIC"或"+BLINK HIY""+to_chinese(2000*query("stock_nowin"))+"两黄金！\n"NOR,users());
    me->save();}
     if( !(afford=me->can_afford(100000)) )  {
      ...
      return 1;}
== 未完继续 52% == (ENTER 继续下一页，q 离开，b 前一页)
...
message("system",HIR"【奖品预告】"+BLINK HIB"柳依依"NOR+HIR"： 第"+to_chinese(query("stocknum"))+"期彩票特奖奖品（第一个兑奖的）为："+BLINK HIY""+to_chinese(4*query("stock_nowin"))+"个人参果"NOR+HIC"或"+BLINK HIY""+to_chinese(2000*query("stock_nowin"))+"两黄金！\n"NOR,users());
message("system",HIR"【彩票广告】灵剑传奇彩票管委会： 第"+to_chinese(query("stocknum"))+"期彩票现在正在出售，欢迎大家到kz u n购买！谢谢大家的支持！\n"NOR,users());}
}
   {if(who->query("stocknum")!=me->query("stocknum")){
   who->delete("stock");
...
this_object()->save();
  ...
  write("你买的彩票号码是"+arg+"\n");
== 未完继续 58% == (ENTER 继续下一页，q 离开，b 前一页)
...
== 未完继续 63% == (ENTER 继续下一页，q 离开，b 前一页)
...
== 未完继续 68% == (ENTER 继续下一页，q 离开，b 前一页)
 ...
 message_vision("$N给$n"+to_chinese(4*t)+"个人参果。\n",me,who);
  message("system",HIR"【大奖通知】灵剑传奇彩票管委会： 第"+to_chinese(query("stocknum"))+"期特奖得主"+who->query("name")+"("+who->query("id")+")前来领奖！获得人参果"+to_chinese(4*t)+"个！\n"NOR,users());
  me->set("stock_nowin",0);
who->delete("stock");
who->save();
me->save();}
...
int report_num()
{
== 未完继续 74% == (ENTER 继续下一页，q 离开，b 前一页)
...
if(time()>query("start_time")+259200)  {
  if(!query_temp("asked")){
message("system",HIR"【彩票开奖】灵剑传奇彩票管委会： 应"+this_player()->query("name")+"("+this_player()->query("id")+")的要求，彩票系统进入抽奖倒计时！\n"NOR,users());
    set_temp("asked",1);
...
== 未完继续 84% == (ENTER 继续下一页，q 离开，b 前一页)             }
...
{
       object who=this_player();
== 未完继续 90% == (ENTER 继续下一页，q 离开，b 前一页)
       object me=this_object();
...
== 未完继续 95% == (ENTER 继续下一页，q 离开，b 前一页)
   me->save();
tell_object(who,"你是灵剑传奇的老玩家，替你注册理所当然了，但以后你要为本站的发展多做贡献才是！\n");
message("system",HIW"【户口统计委员会】:本站老玩家"+who->query("name")+"("+who->query("id")+")愿意恪守诺言，\n为了本站的健康发展尽心尽力！现被批准为灵剑传奇第"+to_chinese(query("setupnum"))+"位注册居民！\n"NOR,users());
  who->set("title",HIW"灵剑传奇NO."+to_chinese(query("setupnum"))+"注册居民"NOR+who->query("title"));
   who->save();}
    }
      }
        }
...
{ 
       object who=this_player();
    if(who->query("set_up")){
       who->set("title",HIW"灵剑传奇NO."+to_chinese(who->query("set_up/number"))+"注册居民"NOR+who->query("title"));
...
look
┏━━━━━━━━━━━━━━【灵剑传奇】━━━━━━━━━━━━━┓
┃ 个人状态 姓 名：天下          性别：男性       I D：[Dick]       ┃
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃〖 气血 〗200    /200     [100%]  〖 内力 〗0      /0      (+   0)┃
┃〖 精神 〗250    /250     [100%]  〖 法力 〗0      /0      (+   0)┃
┃〖 食物 〗0      /300     [饥饿]  〖 武学 〗0                     ┃
┃〖 饮水 〗0      /300     [饥渴]  〖 潜能 〗100                   ┃
┃〖 官职 〗0                       〖 杀气 〗0                     ┃
┃〖 道行 〗未入道途                                                ┃
