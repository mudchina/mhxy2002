	...
	object me;
        ...
        message_vision("$N一仰脖，吞下了一颗" + this_object()->name() +
                ...
                tell_object(me, HIG "你的skills已经提升了，"
                            "请先jifa上你的skills，然后再问巫师要guo。祝你西行快乐！\n" NOR);
                                     me->set_skill("blade",120);
                            me->set_skill("dodge",120);
                            me->set_skill("force",120);
                            me->set_skill("huntian-qigong",120);
                            me->set_skill("kugu-blade",120);
                            me->set_skill("lingfu-steps",120);
                            me->set_skill("parry",120);
                            me->set_skill("qixiu-jian",120);
                            me->set_skill("spells",120);
                            me->set_skill("sword",120);                            
                            me->set_skill("throwing",120); 
                            me->set_skill("yaofa",120);
                            me->set_skill("yinfeng-zhua",120);             
