        ...
        message_vision("$N一仰脖，吞下了一颗" + this_object()->name() +
                ...
                tell_object(me, HIG "你的skills已经提升了，"
                            "请先jifa上你的skills，然后再问巫师要dan。祝你西行快乐！\n" NOR);
                                     me->set_skill("bainiao-jian",100);
                            me->set_skill("dengxian-dafa",100);
                            me->set_skill("ningxie-force",100);
                            me->set_skill("xiaoyaoyou",100);
                            ...
                            me->set_skill("cuixin-zhang",100);
                            me->set_skill("blade",100);
                            me->set_skill("bingpo-blade",100);
