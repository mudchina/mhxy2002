        ...
        message_vision("$N一仰脖，吞下了一颗" + this_object()->name() +
                ...
                tell_object(me, HIG "你的skills已经提升了，"
                            "请先jifa上你的skills，然后再问巫师要dan。祝你西行快乐！\n" NOR);
                                     me->set_skill("baihua-zhang",100);
                            me->set_skill("moonshentong",100);
                            me->set_skill("moonforce",100);
                            me->set_skill("moondance",100);
                            ...
                            me->set_skill("unarmed",100);
                                                 ...
                                                 me->set_skill("snowsword",100);
                                                 me->set_skill("whip",100);
                                                 me->set_skill("jueqingbian",100);
