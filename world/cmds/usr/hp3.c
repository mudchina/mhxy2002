...
int main(object me, string arg)
{
        ...
        write(HIC+trans_word(capitalize(ob->query("id"))));         
        write(HIC"≡"HIR"━━━━━━━━━━━"HIM"☆☆"HIY"梦 "HIM"☆ "HIY"幻 "HIM"☆ "HIY"西 "HIM"☆ "HIY"游"HIM"☆☆"HIR"━━━━━━━━━━━"HIC"≡\n"NOR);
...
write(HIC"≡"+HIR"─────────────────────────"HIG"梦幻西游"HIR"───────"HIC"≡\n"NOR);
        return 1;
}
