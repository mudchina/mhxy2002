...
int main(object me, string arg)
{
 ...
 line = sprintf( " "YEL"≡≡≡≡≡≡≡≡≡≡≡"HIG"个"NOR""YEL"≡≡≡"HIG"人"NOR""YEL"≡≡≡"HIG"档"NOR""YEL"≡≡≡"HIG"案"NOR""YEL"≡≡≡≡≡≡≡≡≡≡≡≡"NOR" \n\n");
   ...
   if( mapp(my["family"]) ) {
    ...
    if( mapp(my["marks"]) ) {
        ...
        if( str != "" ) 
                line += sprintf( " 师承：[%s% 6s%s]  生日：[%s%-22s%s] \n",HIY, str, NOR,
...
line += sprintf( " "HIC"-----------------------------------------------------------------------"NOR"\n");
        ...
        line += "饮水：" + tribar_graph(my["water"], ob->max_water_capacity(),
                ...
                HIG, display_attr(my["kar"], ob->query_kar()), NOR );
                else 
                line += sprintf( " 福缘：[ 隐藏 ]  ");
...
if(ob->query("kill/pkgain") ) { 
       ...
       COMBAT_D->chinese_daoxing(ob->query("kill/pklose")));
        ...
        line += sprintf(" 法力修为：[%s%6s%s]  内力修为：[%s%20s%s] \n\n",
                ...
                line += sprintf( " "YEL"≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡ "HIG"梦幻西游"NOR""YEL" ≡≡≡"NOR"\n\n");
