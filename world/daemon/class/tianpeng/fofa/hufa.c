//by tianlin and valen 2001.7.28
...
{	
        ...
        if( !me->is_fighting() )
                return notify_fail("只有战斗中才能召唤猪兵！\n");
	    ...
	    return notify_fail("你刚叫过猪兵，想想都知道他们很懒！\n");
...
environment(me));
        ...
        seteuid(getuid());
        soldier = new("/d/kaifeng/npc/hufa");
