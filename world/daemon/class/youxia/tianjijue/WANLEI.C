...
int thunderspell(object me, object obj)
{
        ...
        spells = me->query_skill("tianjijue");
        if(obj->is_ghost()==1) {
...
int cast(object me)
{
        ...
        if((int)me->query_skill("tianjijue",1) < 70 )
                return notify_fail("你的天机决修为不够，使不出「万雷咒」！\n");
        ...
        msg = HIY "$N脚踩天罡步，双手握成伏魔印，口中喃喃地念著咒文，\n" NOR;
        msg = msg + HIY "猛地双手一挥，天上打下无数闪电！\n\n" NOR;
