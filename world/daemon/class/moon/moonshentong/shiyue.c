// 蚀月咒?
//By tianlin@mhxy for 2001.12部分优化
inherit SSERVER;
#include <ansi.h>
...
int cast(object me, object target)
{
	...
	msg = HIC
"$N"NOR+HIC"低头默默念起咒文，手中渐渐聚起一团光球，雪白的脸庞似乎发射出柔和的光芒。\n" 
NOR;
...
//here we compare current mana. this is important. you need recover to try again.
	...
	if(success == 1 ){
		msg +=  HIR "$n"NOR+HIR"见到$N"NOR+HIR"祥宁之态，娇美不可方物，心中一荡，却不防那光球一闪，突然射向$n。\n" NOR;
		...
		msg +=  HIR "$N"NOR+HIR"脸色苍白，似乎体力不支，光球在手中渐渐褪去。！\n" NOR;	
		if((int)me->query("mana") > 300 )
			me->add("mana", -300);
