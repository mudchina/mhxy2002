...
mapping *action = ({
	([	"name":			"²ÔËÉÓ­¿Í",
		"action":
"$NÌøµ½¿ÕÖĞ,ÊÖÖĞ$w½ôÎÕ£¬Ïò$nÅüÈ¥£¬¶¼ÓĞËÆ¿ªÉ½´óµ¶Ò»°ã£¬ºÃÒ»Á¦µÀĞÛºñµÄ"+BLINK""+HIC"¡¸²ÔËÉÓ­¿Í¡¹"NOR+"",
		"dodge":		-10,
		"parry":		20,
		"damage":		25,
		"damage_type":		"ÅüÉË"
...
"ÕıÊÇÒ»ÕĞ"+BLINK""+HIR"¡¸ÔÆ¹Èº×·å¡¹"NOR+"£¡",
		"dodge":		  24,
		"parry":		-19,
		"damage":		  25,
		"damage_type":		"¿³ÉË"
        ...
        ([      "name":                 "ÇàÉ½ÒşÒş",
                "action":
"$N·ÉÉíÉÏÇ°£¬ÊÖÖĞ$w¼²Îè£¬Ò»ÕĞ"+BLINK""+HIM"¡¸ÇàÉ½ÒşÒş¡¹"NOR+"»Ã³öÍÅÍÅ½£Ã¢£¬½«$n½ô½ô¹üÔÚÆäÖĞ",
		    "dodge":		 -15,
                "parry":           -15,
                "damage":          35,
                "damage_type":          "ÅüÉË"
        ...
        ([      "name":                 "°×º×ÕñÓğ",
                "action":
"$N´òµ½ĞË·¢£¬İëµØÀïÒ»ÉùÇåĞ¥£¬ÊÖÖĞ$w¼±ËÙÏò$nµÄ$l´ÌÈ¥£¡ÕâÕĞÉ½±Àº£Ğ¥°ãµÄ"+BLINK""+HIG"¡¸°×º×ÕñÓğ¡¹"NOR+"ÍêÈ«½«$n¾ª´ôÁË",
                "dodge":                15,
                "parry":                15,
                "damage":               35,
                "damage_type":          "´ÌÉË"
        ...
        ([      "name":                 "Ğ¯ÊÖÈëÔÆ",
                "action":
"Ö»¼û$Nµ¥×ãÀëµØ£¬Ê¹³öÒ»ÕĞ"+BLINK""+HIW"¡¸Ğ¯ÊÖÈëÔÆ¡¹"NOR+"£¬ÊÖÖĞ$w¼±ËÙ·É½ø£¬Åü³ö²ã²ã½£Æø£¬Ö±Ïò$nµÄ$lÅüÈ¥",
                "dodge":                -10,
                "parry":                -10,
                "damage":               25,
                "damage_type":          "´ÌÉË"
        ...
        ([      "name":                 "ÍËÒşÏÉÏç",
                "action":
"$N¿ìËÙÇ°½ø£¬Ò»Ê½"+BLINK""+HIB"¡¸ÍËÒşÏÉÏç¡¹"NOR+"£¬ÉíËæ½£Æğ£¬Ïò$nÈ«Éí»·³ö¶à³õ½£Ã¢£¬ÕĞÕĞÊÆÈô·ÉÁú¾íÉí£¬$nÄÄÀïÉÁ±ÜµÃ¹ı",
		"dodge":	          -15,
		"parry":		15,
		"damage":		20,
		"damage_type":		"´ÌÉË"
