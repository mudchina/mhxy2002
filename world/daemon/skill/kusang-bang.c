...
mapping *action = ({
        ([      "name":                 "凄风长号",
                "action":
"$N发出一声厉叫，手中$w以一招"BLINK+HIY"「凄风长号」"NOR"狂风骤雨般地向$n的$l连连扫去",
                "dodge":                15,
                "parry":                -10,
                "damage":               25,
                "damage_type":  "砸伤"
        ...
        ([      "name":                 "怨妇伤情",
                "action":               
"$N身形一转，面带戚色，一招"BLINK+CYN"「怨妇伤情」"NOR"使出，\n手中$w好像沾上了$n，甩也甩不开",
                "dodge":                -15,
                "parry":                -20,
                "damage":               30,
                "damage_type":  "砸伤"
        ...
        ([      "name":                 "寒夜祭灵",
                "action":
"$N舞动$w，咯咯一笑，一招"BLINK+HIW"「寒夜祭灵」"NOR"夹着点点磷光砸向$n的$l",
                "dodge":                10,
                "parry":                0,
                "damage":               20,
                "damage_type":  "砸伤"
        ...
        ([      "name":                 "荒野求食",
                "action":
"$N面露乞怜之色，手中$w却轻轻一抖，一招"BLINK+YEL"「荒野求食」"NOR"阴毒无比地刺向$n$l",
                "dodge":                -10,
                "parry":                -10,
                "damage":               25,
                "damage_type":  "刺伤"
        ...
        ([      "name":                 "月下独行",
                "action":
"$N身形往后一缩，手中$w突然暴长数尺，发出青绿之光，\n一招"BLINK+HIM"「月下独行」"NOR"带着森森鬼气砸向$n$l",
                "dodge":                -5,
                "parry":                0,
                "damage":               20,
                "damage_type":  "砸伤"
...
"$N喉咙里发出几声嚎叫，高举$w，不顾一切地冲向$n，几乎与$n贴脸而立！\n手中$w却悄无声息地刺向$n的$l，好厉害的"BLINK+HIB"「小楼夜哭」"NOR"",
        ...
        ([      "name":                 "地狱烈火",
                "action":               
"$N大喝一声，手中$w宛若矫龙飞在半空，大有"BLINK+HIG"「横空出世」"NOR"的气概。\n$n只觉得全身俱在$w笼罩之下",
                "dodge":                -15,
                "parry":                -15,
                "damage":               30,
                "damage_type":  "抽伤"
