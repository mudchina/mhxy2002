...
mapping *action = ({
     ...
     "action":   "$N一式"+HIR"「马嵬坡下泥土中，不见玉颜空死处」"NOR+"，脚踏「巽」位，
...
身形一晃，从$n眼前消失，闪现在$n身后",
   ...
   ([   "name":     "「迟迟钟鼓初长夜，耿耿星河欲曙天」",
     "action":   "$N一式"+HIB"「迟迟钟鼓初长夜，耿耿星河欲曙天」"NOR+"，抢占「坎」位，
...
手中$w化为漫天刀影，夹着隐隐雷声，护住$N全身各处",
   ...
   ([   "name":     "「楼阁玲珑五云起，其中绰约多仙子」",
     "action":   "$N一式"+HIC"「楼阁玲珑五云起，其中绰约多仙子」"NOR+"，绕$n急速旋转，
...
化为一圈幻影，躲开$n的攻势",
   ...
   ([   "name":     "「风吹仙袂飘飘举，犹似霓裳羽衣舞」",
     "action":   "$N一式"+HIW"「风吹仙袂飘飘举，犹似霓裳羽衣舞」"NOR+"，身体急速旋转，
...
在「离」位如一团旋风，化去$n的攻势",
   ...
   ([   "name":     "「玉容寂寞泪阑干，梨花一枝春带雨」",
     "action":   "$N一式"+HIM"「玉容寂寞泪阑干，梨花一枝春带雨」"NOR+"，占住「兑」位，
将手中$w化做点点星光，洒向$n全身",
     "dodge":   -20,
     "parry":   -10,
     "damage":   60,
...
从$n的攻势中闪了出去",
   ...
   ([   "name":     "「天长地久有时尽，此恨绵绵无绝期」",
     "action":   "$N一式"+HIW"「天长地久有时尽，此恨绵绵无绝期」"NOR+"，由「坤」向「乾」疾退，
手中$w化做一道长虹向$n$l击去",
     "dodge":   -25,
     "parry":   -10,
     "damage":   60,
...
{
return CLASS_D("xuanyuan") + "/xuanhu-dao/"+action;
}
