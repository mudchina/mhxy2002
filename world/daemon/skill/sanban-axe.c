...
mapping *action = ({
        ([      "action":
"$N大喊一声"+BLINK""+BLU"「开瓜」"NOR+"，手中$w带着这一吼的威猛之势，朝$n当头劈下",
                "damage":               45,
                "dodge":                20,
                "parry":                -15,
                "damage_type":  	"劈伤",
...
//		"post_action": 		(:takeforce:),
        ...
        ([      "action":
"$N大喊一声"+BLINK""+BLU"「剔牙」"NOR+"，顺势带过大斧，趁$n一愣之际，以斧尾护手刀向$n面门疾戳",
                "damage":               25,
                "dodge":                20,
                "parry":                -15,
                "damage_type": 		"刺伤",
...
//		"post_action": 		(:takeforce:),
        ...
        ([      "action":
"$N大喊一声"+BLINK""+BLU"「掏耳朵」"NOR+"，翻转斧头，手中$w划出一道银弧，奔着$n的脑袋横劈",
                "damage":               40,
                "dodge":                20,
                "parry":                -15,
                "damage_type": 		"劈伤",
...
//		"post_action": 		(:takeforce:),
	...
	([       "action":
"$N大喊一声"+BLINK""+BLU"「捅」"NOR+"，趁$n换招中的空隙，以斧尾护手刀向$n的$l狠狠戳了下去",
                "damage":               30,
                "dodge":                -20,
                "parry":                15,
