...
string damage_msg(int damage, string type)
{
        ...
        case "割伤":
                ...
                if( damage < 100 ) return "结果"MAG"「嗤」"NOR"地一声划出一道伤口！\n";
                if( damage < 170 ) return "结果"MAG"「嗤」"NOR"地一声划出一道"HIR"血淋淋"NOR"的伤口！\n";
                if( damage < 280 ) return "结果"MAG"「嗤」"NOR"地一声划出一道又长又深的伤口，溅得$N满脸"HIR"鲜血！\n"NOR;
        ...
        case "内伤":
                ...
                if( damage < 300 ) return "结果重重地击中，$n「哇」地一声吐出一口鲜血！\n";
                if( damage < 400 ) return "结果"RED"「轰」"NOR"地一声，$n全身气血倒流，口中鲜血狂喷而出！\n";
                return "结果只听见几声喀喀轻响，$n一声惨叫，像滩软泥般塌了下去！！\n";
                break;   
        case "震伤":                
                if( damage < 100 ) return "结果$n受到$N的内力反震，闷哼一声。\n";
                if( damage < 200 ) return "结果$n被$N以内力反震，"CYN"「嘿」"NOR"地一声退了两步。\n";
        ...
        case "抓伤":     
                ...
                if( damage < 400 ) return HIR"结果「啊」地一声惨叫，$n身上$p处被$N抓下了一大片皮肉，鲜血横飞满地！！\n"NOR;
                return "结果伴随着$n一声凄惨的嚎叫，直透$p$l处，连皮带肉扯下一大块，露出了"HIR"血淋淋"NOR"的骨头！！\n";
                break;       
        default:
                if( !type ) type = "伤害";
                str =  "结果造成非常可怕的严重";
