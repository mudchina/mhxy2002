...
mapping *action = ({
	([	"action":
"$N纵身跃起，一招"+BLINK""+HIC"「飞龙在天」"NOR+"，双掌以排山倒海之势击向$n的$l",
		"dodge":		-10,
		"parry":		-10,
		"force":		150,
		"damage_type":		"瘀伤",
...
"$N似退反进，突然欺身向前，五指如钩，对准$n的$l一把抓了过去",
	...
	([	"action":
"只见$N一旋身，双腿如铁棍一般扫向$n。这一招"+BLINK""+HIC"「神龙摆尾」"NOR+"当真是防不胜防",
		"dodge":		-10,
		"parry":		-20,
		"force":		120,
		"damage_type":		"砸伤",
	...
	([	"action":
"$N忽发龙吟，使出一招"+BLINK""+HIC"「龙战于野」"NOR+"，啸声中和身而上，向$n直撞而来",
		"dodge":		10,
		"parry":		-10,
		"force":		100,
		"damage_type":		"撞伤",
		"weapon":		"全身",
            ...
            ([	"action":
"只见$N一个筋斗翻在半空，一招"+BLINK""+HIC"「龙腾四海」"NOR+"将发未发，但是全身劲气疾卷$n",
		"dodge":		0,
		"parry":		-20,
		"force":		150,
		"damage_type":		"内伤",
		"weapon":		"劲气",
            ...
            ([	"action":
"$N身形一长，朝$n劈面就是一拳。这招"+BLINK""+HIC"「苍龙出海」"NOR+"势若奔雷，锐利无比",
		"dodge":		10,
		"parry":		-30,
		"force":		180,
		"damage_type":		"瘀伤",
