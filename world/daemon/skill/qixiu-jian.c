...
"$n识得这招"+BLINK""+HIW"「六亲不认」"NOR"的威力，连忙躲避不迭",
      "dodge":     10,
      "parry":     -20,
      "damage":     40,
      "damage_type":   "割伤",
...
"这招"+BLINK""+HIB"「七窍生烟」"NOR"果然把$n逼得手忙脚乱",
      "dodge":     5,
      "parry":          -10,
      "damage":     30,
      "damage_type":   "刺伤",
...
"这招"+BLINK""+HIM"「八方风雨」"NOR"虽然露出若干空门，但$n也不敢不顾自身安危而贸然进攻",
      "dodge":     5,
      "parry":           -5,
      "damage":     40,
      "damage_type":   "刺伤",
...
//      "post_action":   (:set_busy:),
    ...
    ([
      "action":
"$N连人带剑猛扑向$n的$l。若是这招"+BLINK""+HIR"「九死一生」"NOR"
