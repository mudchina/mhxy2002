...
"这招"+BLINK""+HIC"「尸横遍野」"NOR+"果然奏效，逼得$n手忙脚乱",
                "dodge":                -10,
		"parry":		-15,
                "damage":               20,
                "damage_type":  	"砍伤",
...
"$N的$w如毒蛇一般突然向$n的$l飞去，正是一招"+BLINK""+HIC"「借尸还魂」"NOR+"",
                "dodge":                -15,
		"parry":		-10,
                "damage":               20,
                "damage_type":  	"戳伤",
...
"$N似乎已经打中了$n时，$n突然原地疾转，化为一片黑影不见了。\n",
		"dodge_power":		10,
		"parry_msg":
"$n连忙使一招"+BLINK""+HIC"「借尸还魂」"NOR+"，举$W一挡，借势疾退开去。\n",
		"parry_power":		10,
        ]),
        ([      "name":                 "尸山血海",
                "action":
"$N左手运起排山倒海的掌力，右手$w舞出夺目的寒光，笼罩住$n的全身",
		...
		"parry":		-10,
                ...
                "damage_type":  	"劈伤",
		"dodge_msg":
"$n平平跃起，在空中连转数圈，落在$N身后。原来是"+BLINK""+HIC"「尸山血海」"NOR+"。\n",
		"dodge_power":		10,
		"parry_msg":
"$n展开$W疾挥，但见漫天刀影，这招"+BLINK""+HIC"「尸山血海」"NOR+"果然将$N的攻势挡了回去。\n",
		"parry_power":		10,
        ]),
        ([      "name":                 "毁尸灭迹",
                "action":
"$N忽然间脸色苍白，身体软软的消失在黑暗中。$n在激战中突然不见了敌人，\n"
"惊慌失措间，$N运起了"+BLINK""+HIC"「毁尸灭迹」"NOR+"的半招进攻，一刀向$n的后脑砍去",
                "dodge":                -10,
		"parry":		-10,
                "damage":               25,
                "damage_type":  	"砍伤",
...
"$N虽然看得一清二楚，却道不出这招"+BLINK""+HIC"「毁尸灭迹」"NOR+"的奥妙。\n",
		"dodge_power":		10,
		"parry_msg":
...
"急转中$N忽然一刀砍向$n的$l，好一招"+BLINK""+HIC"「马革裹尸」"NOR+"",
                "dodge":                -10,
		"parry":		0,
                "damage":               25,
                "damage_type":  	"砍伤",
...
"这招"+BLINK""+HIC"「行尸走肉」"NOR+"虽然凶险，但威力奇大，逼的$n连连倒退",
                "dodge":                10,
		"parry":		10,
                "damage":               40,
                "damage_type":  	"砍伤",
		"dodge_msg":
"$n忙用一招"+BLINK""+HIC"「行尸走肉」"NOR+"，膝盖不弯，硬梆梆地连蹦数下，居然避过了$N的招数。\n",
		"dodge_power":		10,
		"parry_msg":
