...
mapping *action = ({
        ([      "name":                 "群魔乱舞",
                "action":
"$N使一招「群魔乱舞」，手中$w狂风骤雨般地向$n的$l连攻数剑",
                "dodge":                0,
                "damage":               20,
                "damage_type":  "刺伤"
        ]),
