...
string long(int arg)
{
	...
	msg+="<img src='http://202.119.144.5/~mudadm/mudweb/icon_folder_new_topic.gif' alt='新帖子' height=15 width=15 border=0>";
...
string read(int arg)
{
	...
	body+="<img src='http://202.119.144.5/~mudadm/mudweb/icon_folder_open.gif' height=15 width=15 border='0'>&nbsp;<a href='board_list.c'>留言板主题页面</a><br>";
	...
	"<font color='black' face='宋体' style='font-size:9pt'>"
	"%s</font>"
	"<br><br>------<br>※ Origin : 妖神之争南京站 < yszz.dhs.org 8000 >"
	"<br>From: %s",
		lower_case(id),name,id,
