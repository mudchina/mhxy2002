//BY tianlin@Mhxy for 2002.1.3.修改
// file: globals.h
//
...
#define AUTOBOOT_D              "/adm/daemons/autobootd"//add by tianlin
#define BJTIME_D                "/cmds/usr/bjtime"
#define NEWS_D                  "/cmds/usr/news"//By tianlin@mhxy for 2002.1.20,设定logind.c文件中的news
...
#define NOTICE_D                "/adm/daemons/noticed"
...
//#define BULLETIN_BOARD        "/std/bbs_board"
