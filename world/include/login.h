...
#define BANNER1 			"/adm/etc/banner1"
#define BANNER2 			"/adm/etc/banner2"
#define BANNER3 			"/adm/etc/banner3"
#define BANNER4 			"/adm/etc/banner4"
#define BANNER5 			"/adm/etc/banner5"
